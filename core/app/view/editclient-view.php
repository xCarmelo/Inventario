            ...
            <form class="form-horizontal" method="post" id="editclient" action="index.php?view=updateclient" role="form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <input value="<?php echo isset($_SESSION['form_data']['phone1']) ? $_SESSION['form_data']['phone1'] : $user->phone1; ?>" type="number" name="phone1" class="form-control <?php echo isset($_SESSION['errors']['phone1']) ? 'is-invalid' : ''; ?>" id="validationCustom05" placeholder="Teléfono" pattern="[0-9]{8}" title="Ingresa un número de teléfono válido (8 dígitos)" required>
                            <div class="invalid-feedback">
